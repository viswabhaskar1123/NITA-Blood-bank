...
export const listDonors = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get('/api/admin/donors', config);
...
export const updateDonor = (donor) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/admin/donors/${donor._id}`, donor, config);
...
export const listPatients = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get('/api/admin/patients', config);
...
export const updatePatient = (patient) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/admin/patients/${patient._id}`, patient, config);
...
export const listDonationRequests = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get('/api/admin/donation-requests', config);
...
export const updateDonationRequest = (id, status, adminNote) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/admin/donation-requests/${id}`,
      { status, adminNote },
      config
    );
...
export const listBloodRequests = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get('/api/admin/blood-requests', config);
...
export const updateBloodStock = (bloodGroup, units) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/admin/blood-stock/${bloodGroup}`,
      { units },
      config
    );
